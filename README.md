...
[!Caution] Scripts intended to parse VCFs generated by [LoFreq](https://csb5.github.io/lofreq/), using other variant callers might require modification to the parsers. 
